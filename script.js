document.addEventListener('DOMContentLoaded', function () {
    ...
    const validateField = function (field) {
      ...
      if (field.minLength && field.minLength > 0) {
        if (!validators.minLength(value, field.minLength)) {
          showError(field, getErrorMessage(field, 'minLength', field.minLength));
          return false;
        }
      }
  ...
  const animatableElements = document.querySelectorAll(
    '.scroll-animate, .fade-in, .slide-up, .slide-in, [data-animate]'
  );
  ...
  if (animatableElements.length > 0 && 'IntersectionObserver' in window) {
    ...
    animatableElements.forEach(function (el, index) {
      if (!el.dataset.animateDelay && !el.dataset.delay) {
        const siblings = el.parentElement ? el.parentElement.querySelectorAll(
          '.scroll-animate, .fade-in, .slide-up, .slide-in, [data-animate]'
        ) : [];
        let siblingIndex = 0;
    ...
    "translations": {
      "en": {
        "consentModal": {
          ...
          "description": "Natural Wood Art uses cookies to enhance your experience, analyze site usage, and assist in our marketing efforts. You can manage your preferences anytime.",
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: 'c88b6598-9312-4c35-8b89-5bc9b28848f2',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || 'c88b6598-9312-4c35-8b89-5bc9b28848f2';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = 'c88b6598-9312-4c35-8b89-5bc9b28848f2';
